...
__all__ = ["SmallRegressor", "MediumRegressor", "LargeRegressor", "MODEL_REGISTRY", "MultiTaskClassifier", "BasicCNNMTL", "CIFARResNet18MTL", "FEMNISTCNN", "LeNetMTL", "RiverFlowMLP", "CelebaCNN"]
