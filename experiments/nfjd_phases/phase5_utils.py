...
def build_trainer(method, model, client_datasets, objective_fn, m, seed,
                  ...
                  fedclient_update_decay: float | None = None,
    ...
    if method == "fedclient_upgrad":
        ...
        server = FedClientUPGradServer(
            ...
            update_decay=fedclient_update_decay,
            total_rounds=num_rounds,
...
def run_experiment(exp_id, method, model, client_datasets, objective_fn, m, seed,
    ...
    trainer = build_trainer(
        ...
        fedclient_update_decay=fedclient_update_decay,
    ...
    row = {
        ...
        "fedclient_update_decay": fedclient_update_decay if method == "fedclient_upgrad" else "",
